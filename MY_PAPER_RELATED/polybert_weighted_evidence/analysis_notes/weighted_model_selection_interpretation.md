...
The selected model was subsequently refit on all 6,270 labeled rows and applied to 32,610 generated candidates. Those predictions support a generated-pool sensitivity comparison, while the original baseline-based MD selection remains unchanged.
