...
class LSTMCVAE(nn.Module):
    def __init__(self, d_model=256, latent_dim=128, vocab_size=None, max_len=None, pad_idx=None):
        super().__init__()
        ...
        self.encoder = LSTMEncoder(vocab_size=vocab_size, pad_idx=pad_idx)
        self.decoder = LSTMDecoder(latent_dim=latent_dim, vocab_size=vocab_size, pad_idx=pad_idx)
