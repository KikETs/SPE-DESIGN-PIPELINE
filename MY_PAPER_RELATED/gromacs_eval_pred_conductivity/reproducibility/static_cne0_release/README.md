...
- Static cNE0 contact definition: replica-specific Li-TFSI oxygen RDF peak cutoff and zero persistence threshold (`tau = 0 ps`).
...
| RDF/static cNE0 analysis | `analysis/rdf_peak_tau0_replica_eval.py` and `analysis/persistence_sweep_and_hybrid.py` |
...
- Candidate-mean static cNE0: `3.265441986722e-4 S cm^-1`.
- Replica-3 static cNE0: `3.423792401854e-4 S cm^-1`.
- Replica-specific RDF peak cutoff: `0.218 nm`.
...
- Static cNE0: `4.144597660417e-5 S cm^-1`.
- RDF peak cutoff: `0.216 nm`.
...
python scripts/analysis/rdf_peak_tau0_replica_eval.py \
  --out-dir results/rdf_cutoff_latest60_6groups \
  --temperature-k 353 \
  --workers 8 \
  --force-cne
